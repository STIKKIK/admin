...
class Crud_model extends CI_Model
{
    ...
    public function get_all_product()
    {
        ...
        //$this->datatables->add_column('view', '<button type="button" class="btn btn-warning edit_record" data-toggle="modal" data-target="#ModalUpdate" data-code="$1" data-name="$2" data-price="$3" data-category="$4">Update</button>', 'product_code,product_name,product_price,category_id,category_name');
