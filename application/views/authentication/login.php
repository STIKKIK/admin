                ...
                <?php echo form_open('user_authentication/user_login_process'); ?>
                    ...
                    <div class="social-login-content">
                      <div class="social-button">
                            ...
                            <button type="button" class="btn social facebook btn-flat btn-addon mb-3" onclick="location.href='<?php echo $loginurl ?>'"><i class="ti-facebook"></i>Sign in with facebook</button>
