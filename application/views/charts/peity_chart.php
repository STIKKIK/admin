<div class="breadcrumbs">
    ...
    <script type="text/javascript" src="<?php echo base_url('assets/js/lib/peitychart/jquery.peity.min.js') ?>"></script>
    <!-- scripit init-->
    <script type="text/javascript" src="<?php echo base_url('assets/js/lib/peitychart/peitychart.init.js') ?>"></script>
    <!-- scripit init-->
