<div class="breadcrumbs">
    ...
    <!--  Chart js -->
    <script type="text/javascript" src="<?php echo base_url('assets/js/lib/chart-js/Chart.bundle.js') ?>"></script>
    <script type="text/javascript" src="<?php echo base_url('assets/js/lib/chart-js/chartjs-init.js') ?>"></script>
